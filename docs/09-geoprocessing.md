...
alt="QGIS processing toolbox" width='100%' height='100%' />
...
alt="Processing toolbox → Vector general →
Reproject layer" width='100%' height='100%' />
...
alt="Input layer = libraries" width='100%' height='100%' />
...
alt="Target CRS = Project CRS" width='100%' height='100%' />
...
alt="Saving output to file" width='100%' height='100%' />
...
alt="Run the tool" width='100%' height='100%' />
...
alt="Reprojected output layer in map canvas" width='100%' height='100%' />
...
alt="Processing toolbox → Vector Geometry → Buffer" width='100%' height='100%' />
...
alt="Parameters: Input layer = libraries, Distance = 1km" width='100%' height='100%' />
...
alt="Saving output layer" width='100%' height='100%' />
...
alt="Output buffered layer in the map canvas" width='100%' height='100%' />
...
alt="Vector analysis → Count points in polygon" width='100%' height='100%' />
...
alt="Save output, click Run" width='100%' height='100%' />
...
alt="Output layer attribute table" width='100%' height='100%' />