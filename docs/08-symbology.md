...
alt="Neighbourhoods layer → Right-click → Properties" width='70%' height='100%' />
...
alt="Symbology tab of properties window showing single symbol" width='100%' height='100%' />
...
alt="Changing symbology type from Single Symbol to Categorized" width='100%' height='100%' />
...
alt="Value field = Category" width='100%' height='100%' />
...
alt="Symbology showing unique values" width='100%' height='100%' />
...
alt="Categorical symbology of neighbourhoods layer in the map canvas" width='100%' height='100%' />
...
alt="Graduated symbology in the map canvas" width='100%' height='100%' />